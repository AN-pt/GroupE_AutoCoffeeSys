class Decentralization:
    ...
    EDIT = 2
    ALL = 3
    def __init__(self, decentralizationID = "", isSale = 0, isProduct = 0, isCategory = 0, isRecipe = 0, isImport = 0, isBill = 0, isWarehouses = 0, isAccount = 0, isBarista = 0, isCustomer = 0, isDiscount = 0, isDecentralize = 0, decentralizationName = "", deleted = False):
    ...
    def setArray(self) -> None:
        ...
        self.__arr.append(self.__isBarista)
    ...
    def getIsBarista(self) -> int:
        return self.__isBarista

    def setIsBarista(self, isBarista) -> None:
        self.__isBarista = isBarista
    ...
    def __str__(self):
        ...
        for i in self.__arr:
            if i == 0:
                self.string.append ("Remove")
            if i == 1:
                self.string.append ("View")
            if i == 2:
                self.string.append ("Edit")
            if i == 3:
                self.string.append ("View and edit")
        s=" | ".join(self.string)
