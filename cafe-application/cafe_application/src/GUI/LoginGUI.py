...
class LoginGUI(Frame):
    ...
    def init_components(self):
        ...
        style = ttk.Style()
        style.configure('TSeparator', background='#650000')
        separator = ttk.Separator(self.panel1, orient='horizontal', style='TSeparator')
        separator.place(relx=0, rely=1, anchor='sw', relwidth=1)

        self.brandName = Label(self.panel1, text="AutoCafé", font=("calibri", 45, "bold"), fg="#650000", bg="#ffffff")
        self.brandName.place(relx=0.5, rely=0, anchor="n")

        # Login Form
        self.panel2 = Frame(self.contentPane, bg="#650000", width=300, height=400)
        self.panel2.pack(side='left')

        self.logo = Image.open(r"./cafe_application/img/logo_cafe.png")
        self.logo = self.logo.resize((273, 267))
        self.logo = ImageTk.PhotoImage(self.logo)

        self.logoLabel = Label(self.panel2, image=self.logo, bg="#650000")
        ...
        self.loginLabel = Label(self.panel4, text="Login", font=("calibri", 30, "bold"), fg="#650000", bg="#ffffff")
        self.loginLabel.pack()

        self.panel5 = Frame(self.panel3, bg="#ffffff", width=300, height=150)
        self.panel5.pack()

        self.usernameLabel = Label(self.panel5, text="Username", font=("Helvetica", 12), fg="#000000", bg="#ffffff")
        self.usernameInput = Entry(self.panel5, font=("Helvetica", 14), bg="#ffffff", fg="#000000")
        self.passwordLabel = Label(self.panel5, text="Password", font=("Helvetica", 12), fg="#000000", bg="#ffffff")
        self.passwordInput = Entry(self.panel5, font=("Helvetica", 14), bg="#ffffff", fg="#000000", show="*")
        ...
        # Login Panel Buttons
        self.loginButton = Button(self.panel3, text="Login", font=("calibri", 12, "bold"), bg="#ffffff", fg="#650000", command=self.login)
