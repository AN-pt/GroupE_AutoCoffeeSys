...
class BillGUI(Frame):
    ...
    def init_components(self):
        ...
        self.table.heading("2", text="BARISTA_ID")
    ...
    def showDetailsBill(self, event):
        for row in self.table.selection():
            ...
            self.cbbBaristaID.set(values[2])
            self.cbbBaristaID.configure(state="readonly")
    ...
    def upd(self):
        ...
        self.newBill = Bill(self.TextFieldsForm[0].get(), self.cbbCustomerID.get(), self.cbbBaristaID.get(), dop, float(self.TextFieldsForm[2].get()), False)
